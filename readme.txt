...
Минимальные системные требования:
 ...
 OpenSSL Toolkit v1.1.1a и новее.
...
Q. Почему для x86 сборки FarUE3 есть инсталлятор и программа обновления, а для
   х64 их нет?

A. х64 хранит настройки в своём каталоге и просто разархивируется на рабочий
   носитель, а х86 использует инсталлятор т.к. хранит ряд настроек в Реестре.
