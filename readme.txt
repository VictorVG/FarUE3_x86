...
Минимальные системные требования:
 ...
 OpenSSL Toolkit v1.1.1g и новее.
...
Q: Как подключится к сетевому диску если Far не видит сети?
...
Q: Скорость работы очень "высокая". Например дистрибутив GIMP 2.10.18 Rev 2
   ...
   innounp/exe v0.49 чуть больше двух минут ничего останавливать не
   потребовалось.
